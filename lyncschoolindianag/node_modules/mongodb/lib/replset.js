...
var EventEmitter = require('events').EventEmitter
  ...
  , ServerPrograms = require('./topology_base').ServerPrograms
...
ReplSet.prototype.capabilities = function() {
  if(this.s.sPrograms) return this.s.sPrograms;
  if(this.s.replset.lastIsMaster() == null) return null;
  this.s.sPrograms = new ServerPrograms(this.s.replset.lastIsMaster());
  return this.s.sPrograms;
}

define.classMethod('capabilities', {callback: false, promise:false, returns: [ServerPrograms]});
